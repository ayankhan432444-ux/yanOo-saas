...
<head>
    ...
    <title>Register | YanOo Brand</title>
...
<body class="p-4 py-10">
    ...
    <div class="register-card w-full max-w-[360px] p-8 rounded-[2rem] animate-in fade-in zoom-in duration-500">
        ...
        <div class="text-center mb-6">
            ...
            <h1 class="text-xl font-black text-slate-900 tracking-tighter uppercase italic">Create Instance</h1>
            <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Register YanOo Node</p>
        </div>

        <form id="registerForm" class="space-y-4">
            <div>
                <label class="block text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1 ml-1">Company</label>
                <input type="text" id="company_name" required placeholder="Business Name" 
            ...
            <div class="pt-2">
                <button type="submit" id="regBtn" class="w-full bg-slate-900 hover:bg-black text-white font-bold py-3.5 rounded-xl text-[11px] uppercase tracking-widest transition-all flex items-center justify-center gap-2">
                    Register 
        ...
        <div class="mt-6 pt-5 border-t border-slate-50 text-center">
            <p class="text-[10px] font-bold text-slate-400 uppercase mb-2">Already have an account?</p>
            <a href="/login" class="text-blue-600 font-bold uppercase text-[10px] tracking-widest hover:underline">
                Sign In Instead
            </a>
        </div>
    </div>
        ...
        document.getElementById('registerForm').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (res.ok) {
                    ...
                    alert('Registration Failed: ' + (data.message || 'Check details'));
